    ...
    public class AssetsFileReader : BinaryReader
    {
        ...
        public int ReadInt24()
        {
            unchecked
            {
                return BigEndian
                    ? (int)ReverseInt(
                        (uint)System.BitConverter.ToInt32(ReadBytes(3).Concat(new byte[] { 0 }).ToArray(), 0))
        ...
        public uint ReadUInt24()
        {
            ...
            {
                return BigEndian
                    ? ReverseInt(System.BitConverter.ToUInt32(new byte[] { 0 }.Concat(ReadBytes(3)).ToArray(), 0))
